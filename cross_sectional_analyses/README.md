...
Step 1: For each week's comments, the aggressive language variables are computed using Detoxify. The following notebook is used-
  * cross_sectional_analyses/aggressiveLanguageDetection.ipynb<br>
Step 2: For each week's comments, the node embeddings are generated. The following notebook is used-
  * cross-sectional_analyses/structuralSimilarity.ipynb<br>
Step 3: For each week's comments, the word embeddings data are generated using SBERT. The following notebook was used-
  * cross_sectional_analyses/semanticSimilarity.ipynb<br>
